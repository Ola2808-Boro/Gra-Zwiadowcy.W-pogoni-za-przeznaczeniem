#ifndef ALYSSMAINWARING_H
#define  ALYSSMAINWARING_H
...
class AlyssMainwaring :public Entity
{
private:
    Clock damageTimer;
...
public:
    //konstruktor
    AlyssMainwaring(float x, float y, Texture& texture_sheet);
    //destruktor
    virtual ~AlyssMainwaring();
